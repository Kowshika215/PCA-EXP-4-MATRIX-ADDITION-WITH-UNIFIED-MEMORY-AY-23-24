...
<h3>AIM:</h3>
<h3>ENTER YOUR NAME</h3> KOWSHIKA R
<h3>ENTER YOUR REGISTER NO</h3> 212224220049
<h3>EX. NO</h3> 4
<h3>DATE</h3> 27.05.2026
...
```
```
!nvcc -o unifmem1 unifmem1.cu
```
```
!nvcc -o unifmem2 unifmem2.cu
```
```
!nvprof ./unifmem1
```
...
<img width="1386" height="760" alt="image" src="https://github.com/user-attachments/assets/c619748f-0bab-4295-b0e1-6179375c06ab" />

<img width="1364" height="774" alt="image" src="https://github.com/user-attachments/assets/0d5ea13c-3f91-42a4-a4e0-0d00a1361b44" />

## RESULT:
Thus the program has been executed by using CUDA to perform parallel edge detection on an image using the Sobel filter and improve processing speed through GPU acceleration.
